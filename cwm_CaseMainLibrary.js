...
function SetDescriptionField() {
    //Xrm.Page.getAttribute("description").setValue("This is a test from JavaScript");
}
...
function setDefaultIndependentContractor(){
    ...
    if(xrmPage.getAttribute("customerid").getValue() != null)
    {
        var accountId = xrmPage.getAttribute("customerid").getValue()[0].id.replace('{','').replace('}','');
